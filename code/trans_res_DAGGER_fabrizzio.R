...
#--------------------------
feature_coord_file<-"Path/to/feature/bedfile"
feature_pval_file<-"Path/to/cluster_pvalue/tbl"

BHiCect_res_file<-"Path/to/cluster/spec_res/folder"

out_tsv<-"Path/to/output/file"
