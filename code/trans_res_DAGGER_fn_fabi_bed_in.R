...
#--------------------------
feature_coord_file<-"~/Documents/multires_bhicect/Bootstrapping-Pipeline-Python-R/data/features/HMEC/CTCF/ENCFF710VEH.bed"
...
out_file<-"./data/DAGGER_tbl/HMEC_CTCF_trans_res_dagger_fabi_tbl.Rda"
out_tsv<-"./data/DAGGER_tbl/HMEC_CTCF_trans_res_dagger_fabrizzio_tbl.tsv"
